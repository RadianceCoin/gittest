#############################################################################
# Makefile for building: RadianceCoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: ?? ?? 20 00:54:41 2014
# Project:  RadianceCoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile RadianceCoin-qt.pro
#############################################################################
...
Makefile: RadianceCoin-qt.pro  ../QT/4.8.5/mkspecs/default/qmake.conf ../QT/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile RadianceCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/RadianceCoin-master/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/RadianceCoin-master/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/RadianceCoin-master/src/leveldb/libleveldb.a: FORCE
