...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("RadianceCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("RadianceCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "RadianceCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"124.232.140.118", "124.232.140.118"}, //Main RadianceCoin Seed Node
	{"103.229.126.73", "103.229.126.73"}, 
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("RadianceCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("RadianceCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("RadianceCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("RadianceCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. RadianceCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("RadianceCoin-start");
